...
const linkClass ="hover:text-red cursor-pointer transition ease-linear hover:-translate-y-1 hover:scale-110"
...
function Navbar() {
  ...
  return (
      ...
      <nav className="container mx-auto bg-white rounded-full mt-10 py-3 px-5 md:py-6 md:px-10 flex justify-between shadow-2xl sticky top-0 z-10 transition ease-in">
        <FaBars className="lg:hidden text-2xl md:text-3xl"/>
        <ul className="hidden lg:flex space-x-12 font-semibold">
        <li className={linkClass}><Link to="team" spy={true}
      smooth={true} duration={300}
      activeClass="text-red transition ease-in" offset={-100}>Team</Link></li>
        <li className={linkClass}><Link to="fundraising" spy={true}
      smooth={true} duration={300}
      offset={-100} activeClass="text-red transition ease-in">Fundraising</Link></li>
        <li className={linkClass}><Link to="about" spy={true}
      smooth={true} duration={300}
      offset={-100} activeClass="text-red transition ease-in">What We Teach</Link></li>
        <li className={linkClass}><Link to="podcasts" spy={true}
      smooth={true} duration={300}
      offset={-100} activeClass="text-red transition ease-in">Podcast</Link></li>
        <li className={linkClass}><Link to="volunteer" spy={true}
      smooth={true} duration={300}
      activeClass="text-red transition ease-in">Volunteer</Link></li>
        <li className={linkClass}><Link to="contact" smooth={true} duration={300} spy={true} activeClass="text-red transition ease-in" offset={-100}>Contact</Link></li>
        </ul>
