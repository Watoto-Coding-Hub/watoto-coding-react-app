...
return(
    <div className="Fundraising bg-dark pt-10 text-white flex flex-col justify-center items-center max-sm:px-12 ">
   <h2 className="text-5xl font-semibold">Fundrasing</h2>
...
<button className="mt-10 py-3 px-10  mb-10 bg-green-2">
    <p className="text-2xl">VIEW THE DOCUMENT</p>
</button>

<h2 className="text-5xl font-semibold mt-10">Volunteer</h2>
...
<button className="mt-10 py-3 px-10  bg-green-2 mb-5">
