...
function Team() {
  return (
    <div className="Team bg-green-1 text-white mx-6 py-6" >
      
      <div className='flex'>
<img src={Img4} alt="person" width="200px" height='150px' />
<p className='text-2xl grid place-content-center pl-5'>Leonard Onyango was born & raised in Kibera Slums, he is amongst the 
...
<p className='text-2xl grid place-content-center pl-5 '>Costanza Casullo is from Italy and joined Watoto Coding as a volunteer in 2022. She is a techie passionate about web design and game development and currently 
